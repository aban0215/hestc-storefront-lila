        ...
        <Popover className="relative inline-block">
            {({ open, close }) => (
                ...
                >
                    <Popover.Button
                        ref={buttonRef}
                        className={`flex items-center gap-x-1.5 text-ui-fg-subtle hover:text-ui-fg-base transition-all py-1.5 px-3 rounded-md min-w-[70px] outline-none ${
                    ...
                    >
                        {current ? (
                            <>
                                ...
                                />
                                <span className="text-sm font-medium hidden sm:inline whitespace-nowrap uppercase">
                                    {current.country}
                                </span>
                            </>
                        ) : (
